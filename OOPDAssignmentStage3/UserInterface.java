...
public class UserInterface
{
    ...
    private void addRecord( MusicCollection library )
    {
        ...
        try
        {
            library.addMusic( new Record( name, artist, duration,
    ...
    private void addDigital( MusicCollection library )
    {
        ...
        try
        {
            library.addMusic( new Digital( name, artist, duration,
                type ) );
        }
        catch ( IllegalArgumentException ex )
        {
    ...
    private void addCassette( MusicCollection library )
    {
        ...
        } else
        {
            try
            {
                library.addMusic( new Cassette( name, artist, duration,
    ...
    private void mediaSearchMenu( MusicCollection library )
    {
        ...
        switch( option )
        {
            case 1:
                System.out.print( "Please enter the play speed " +
                    "of the record: " );
                search( sc.nextLine(), library );
                break;
            case 2:
                System.out.print( "Please enter the codec " +
    ...
    private void search( String inSearch, MusicCollection library )
    {
        Music[] result = library.searchMusic( inSearch );
        double duration = 0.0;
        System.out.println( "\nNumber of songs: " + result.length );
        for ( int i = 0; i != result.length; i++ )
        {
            duration = Music.addDuration(
                duration, result[i].getDuration() );
        }

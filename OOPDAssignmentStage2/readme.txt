Jakob Wyatt 19477143 OOPDAssignmentStage2 Readme

Date created: 24/09/2018

Date last modified: 17/10/2018

Purpose: To implement all functionality for the MusicLibrary project.
...
Files in project:
    ...
    -MusicCollection_Pseudocode.txt
    -Record.java
    -Record_Pseudocode.txt
    -Digital.java
    -Digital_Pseudocode.txt
    -Cassette.java
    -Cassette_Pseudocode.txt
    -TestResults.txt
    -readme.txt
    -report.tex
    -report.pdf
    -DeclarationOfOriginality.pdf
    -DeclatationOfOriginality_Signed.pdf
    -documentation.txt
...
Functionality:
    All functionality for the program has been implemented.
